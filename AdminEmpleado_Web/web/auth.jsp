...
<div class="auth-wrapper">
    <div class="auth-card-container">
        ...
        <div class="auth-tabs" id="authTabs">
            <button class="active" onclick="switchAuthTab('admin', event)">
                <i class="fas fa-user-shield"></i> Admin
            </button>
            <button onclick="switchAuthTab('empleado', event)">
        ...
        <div class="auth-panel" id="panel-admin">
            <div class="auth-panel-header" style="background: #fafafa;">
                <div class="icon-circle icon-admin"><i class="fas fa-user-shield"></i></div>
            ...
            <div class="auth-panel-body">
                <form action="AdminLoginServlet" method="post">
                    <div class="form-group">
                        <label class="form-label">C&oacute;digo administrador</label>
                        <input type="text" name="adminCode" class="form-input" placeholder="Ingresa tu c&oacute;digo" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Contrase&ntilde;a</label>
                        <input type="password" name="password" class="form-input" placeholder="Ingresa tu contrase&ntilde;a" required>
                    </div>
                    <button type="submit" class="btn btn-dark btn-block btn-lg" style="margin-top: 8px;">
        ...
        <!-- ===================== EMPLEADO ===================== -->
        <div class="auth-panel" id="panel-empleado" style="display: none;">
            <div class="auth-panel-header" style="background: #eff6ff;">
                <div class="icon-circle icon-empleado"><i class="fas fa-user-tie"></i></div>
                <h3>Acceso Empleado</h3>
                <p>Panel operativo - Seguimiento y POS</p>
            </div>
            <div class="auth-panel-body">
                <form action="AdminLoginServlet" method="post">
                    <input type="hidden" name="loginType" value="empleado">
                    <div class="form-group">
                        <label class="form-label">C&oacute;digo empleado</label>
                        <input type="text" name="adminCode" class="form-input" placeholder="Ingresa tu c&oacute;digo" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Contrase&ntilde;a</label>
                    ...
                    <button type="submit" class="btn btn-block btn-lg" style="margin-top: 8px; background: #2563eb; color: white;">
                        <i class="fas fa-right-to-bracket"></i> Acceder al Panel
                    </button>
                </form>
            </div>
