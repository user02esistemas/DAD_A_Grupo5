...
<body>
    ...
    <nav class="navbar" id="mainNav">
        <a href="#" class="logo">New<span>One</span> <span style="font-size: 14px; font-weight: 500; color: var(--gray-500); margin-left: 8px;">Portal Interno</span></a>
        <div class="nav-links">
    ...
    <header id="inicio" class="hero">
        <div class="hero-content">
            ...
            <h1>Portal de Administraci&oacute;n y Empleados</h1>
            <p>Sistema interno para la gesti&oacute;n de pedidos, inventario, reportes y control de operaciones.</p>
