                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <span style="font-size: 13px; color: var(--gray-600);"><%= e.getRol() != null ? e.getRol() : "Admin" %></span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formNuevoEmpleado" onsubmit="return false;">
                    ...
                    <button class="btn btn-primary btn-block" onclick="guardarNuevoEmpleado()" style="margin-top: 8px;">
            ...
            <div class="modal-body">
                <form id="formEmpleado" onsubmit="return false;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
                        ...
                        <div class="form-group">
                            <label class="form-label">Contrase&ntilde;a</label>
                            <input type="text" name="password" id="empPass" class="form-input" required>
                        </div>
                    </div>
                    <button class="btn btn-primary btn-block" onclick="guardarEdicionEmpleado()" style="margin-top: 8px;">
