...
<script>
    ...
    function loadChatMessages() {
        ...
        fetch('ComunicacionServlet').then(function(r){ return r.json(); }).then(function(msgs){
    ...
    function sendChatMsg() {
        ...
        fetch('ComunicacionServlet', { method: 'POST', body: fd }).then(function(r){ return r.text(); }).then(function(d){
            if (d.trim() === 'success') {
                input.value = '';
                loadChatMessages();
            }
