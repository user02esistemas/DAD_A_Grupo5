    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("get_empleado".equals(accion)) {
                ...
                if (e != null) {
                    out.print(String.format("{\"id\":%d, \"nombre\":\"%s\", \"codigo\":\"%s\", \"pass\":\"%s\"}",
                            e.getIdUsuario(), e.getNombreCompleto(), e.getCodigoEmpleado(), e.getPassword()));
                }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("crear_empleado".equals(accion) || "actualizar_empleado".equals(accion)) {
                ...
                if(exito) response.getWriter().write("success");
